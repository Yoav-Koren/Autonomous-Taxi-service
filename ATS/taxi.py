...
class Taxi:
    ...
    def drive(self):
        ...
        elif self.PickedUpPassenger == False: # If the taxi is driving to pick up a passenger
        ...
        elif self.PickedUpPassenger: # Checks if the passenger has been picked up and the taxi is moving to the end point
