...
class Passenger:
    ...
    def _generate_x_endpoint(self):
        ...
        if (temp_x_end) > Constant.GRID_SIZE: # Checks if the new X end point is inside the grid if not, we store the over_flow for when we move Y end point
            over_flow = temp_x_end - Constant.GRID_SIZE # over_flow incase our new generated point is outside our grid system
            ...
            self.end_x_pos = Constant.GRID_SIZE # We set the end point as the max column 
    ...
    def _generate_y_endpoint(self):
        ...
        if (temp_y_end) > Constant.GRID_SIZE: # Checks if the new Y end point is inside the grid if not, we store the over_flow for when we move Y end point
            over_flow = temp_y_end - Constant.GRID_SIZE # over_flow incase our new generated point is outside our grid system
            ...
            self.end_y_pos = Constant.GRID_SIZE # We set the end point as the max column 
