...
class Passenger:
    def __init__(self,ID, current_x_pos = None ,current_y_pos = None,end_x_pos = None,end_y_pos = None,color = None):
        ...
        self.max_distance = random.randint(1,2000) # Generates a max distance for the end point
    ...
    def _generate_x_endpoint(self):
        ...
        if (temp_x_end) > 20000: # Checks if the new X end point is inside the grid if not, we store the over_flow for when we move Y end point
            over_flow = temp_x_end - 20000 # over_flow incase our new generated point is outside our grid system
            ...
            self.end_x_pos = 20000 # We set the end point as the max column 
    ...
    def _generate_y_endpoint(self):
        ...
        if (temp_y_end) > 20000: # Checks if the new Y end point is inside the grid if not, we store the over_flow for when we move Y end point
            over_flow = temp_y_end - 20000 # over_flow incase our new generated point is outside our grid system
            ...
            self.end_y_pos = 20000 # We set the end point as the max column 
